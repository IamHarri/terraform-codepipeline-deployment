module "asg" {
  ...
  iam_role_name               = "${var.repository_name}-ec2-role"
  iam_role_path               = "/ec2/"
  iam_role_description        = "Iam role created by launch template"
  iam_role_policies = {
    AmazonSSMManagedInstanceCore  = data.aws_iam_policy.AmazonSSMManagedInstanceCore.arn
    AmazonEC2RoleforAWSCodeDeploy = data.aws_iam_policy.AmazonEC2RoleforAWSCodeDeploy.arn
  }
